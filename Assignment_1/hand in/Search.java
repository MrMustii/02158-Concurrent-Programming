...
// Uncomment for Problem 2+
            ...
            int avrageTaskLength = len/ntasks;
            int length_pattern = pattern.length-1;
            for (int i=0; i<ntasks-1;i++){
                taskList.add(new SearchTask(text, pattern, i*avrageTaskLength, (i+1)*avrageTaskLength+length_pattern));
            }

            taskList.add(new SearchTask(text, pattern, (ntasks-1)*avrageTaskLength,len));
